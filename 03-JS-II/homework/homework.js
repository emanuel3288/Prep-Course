...
function esDiezOCinco(numero) {
  ...
  // Tu código:
  let esIgualADiezOCinco = numero===10 || numero===5
  return esIgualADiezOCinco;
}
...
function estaEnRango(numero) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  let esMenorA50= numero<50;
  let esMayorA20= numero>20;
  return esMayorA20 && esMenorA50;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  return numero.toString().length===3  // lo convertí en string y luego calcule la longitud saber si es igual a 3(es decir, tiene 3 digitos en total)
}
...
function doWhile(numero) {
  ...
  let indice=0;
  do {
    totalActual+=5;         //Le suma 5 por cada vuelta.
    indice+=1;              //Le suma 1 por cada vuelta.
  }while(indice<8);
  return totalActual+numero;
}
